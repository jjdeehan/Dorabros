            ...
            <div id="navbarSupportedContent" style={{'color':'white'}} className="collapse navbar-collapse opaque">
              ...
              <Nav className="" navbar>
                {this.state.navbarSections.map((el, index) => {
                  return <NavItem className="clickable" style={{'color':'white', fontFamily:'FatFrank', }} key={el.page}>
                  ...
                  <NavItem className="clickable" style={{border:"1px solid white", "wordWrap":"none","borderRadius":"20px",'color':'white', fontFamily:'FatFrank'}} key={"SPONSOR US"}>
                      <NavLink style={{width:"150px",color:'white', fontFamily:'FatFrank', fontSize:22}} href="https://uk.virginmoneygiving.com/Team/Dorabros" target="_blank" onClick={() => this.pageClicked("SPONSOR US")}>{"  SPONSOR US  "}</NavLink>
                    </NavItem>
              </Nav>
              </div>
