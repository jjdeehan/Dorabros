  ...
  render () {
    return (
        <div style={{position:"fixed", width:"100%", zIndex:100}}>
          ...
          <NavbarBrand>
            <NavLink onClick={this.itemClicked} to="/">
               <svg id="svg" version="1.1" width="120" height="55" xmlns="http://www.w3.org/2000/svg" style={{display:"block", color:"#212529"}}>
          ...
          <NavItem style={{transform:"translate(-50px,-10px)", paddingRight:0}}>
                <NavLink style={{color:"white", fontSize:20}}  onClick={this.itemClicked} to="/">DORABROS</NavLink>
          </NavItem>
          <NavbarToggler
          ...
          >
            <NavbarNav right>
              <NavItem>
                <NavLink style={{color:"white", fontSize:20}}  onClick={this.itemClicked} to="/why">Why</NavLink>
              </NavItem>
              ...
              <NavItem>
                <NavLink style={{color:"white", fontSize:20}} onClick={this.itemClicked} to="/challenges">Challenges</NavLink>
              </NavItem>
              {!this.state.isOpen && <NavItem style={{color:"white", transform:"translate(0px,10px)"}}>
                &#183;
              </NavItem>}
              <NavItem>
                <NavLink style={{color:"white", fontSize:20}} onClick={this.itemClicked} to="/team">Team</NavLink>
              </NavItem>
              {!this.state.isOpen && <NavItem style={{color:"white", transform:"translate(0px,10px)"}}>
                &#183;
              </NavItem>}
              <NavItem>
                <NavLink style={{color:"white", fontSize:20}} onClick={this.itemClicked} to="/thankYou">Wall of Fame</NavLink>
              </NavItem>
              {!this.state.isOpen && <NavItem style={{color:"white", transform:"translate(0px,10px)"}}>
                &#183;
              </NavItem>}
              <NavItem>
                <NavLink style={{color:"white", fontSize:20}} onClick={this.itemClicked} to="/ball">Ball</NavLink>
              </NavItem>
              {!this.state.isOpen && <NavItem style={{color:"white", transform:"translate(0px,10px)"}}>
                &#183;
              </NavItem>}
              ...
              <NavItem >
                  <NavLink onClick={this.itemClicked} style={{
...
<hr style={{backgroundColor:"white", width:"80%", float:"left", height:1}}/>
          ...
          <hr style={{backgroundColor:"white", width:"80%", float:"left", height:1}}/>
          <Link onClick={this.itemClicked} to="/corporateSponsorship">
                        <div 
