  ...
  _createClass(InstafeedComponent, [{
    ...
    value: function render() {
      var instafeed = new _instafeed2.default({
        ...
        template: this.props.template || '<a href=\'{{link}}\' target=\'_blank\' class=\'col-md-4\'><img class=\'col-md-4\' src=\'{{image}}\' /><div class=\'col-md-4\'><div class=\'instafeed__item__overlay--inner\'><p class=\'instafeed__item__caption\'>{{model.short_caption}}</p><p class=\'instafeed__item__location\'>{{location}}</p></div></div></a>'
      });
      instafeed.run();
